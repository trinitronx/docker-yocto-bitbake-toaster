...
ADMINS = (
     (os.getenv('TOASTER_ADMIN_NAME', 'Your Name'), os.getenv('TOASTER_ADMIN_EMAIL', 'your_email@example.com')),
)
...
STATICFILES_DIRS = (
    ...
    "/app/lib/toaster/toastergui/static",
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "/app/lib/toaster/toastergui/templates",
)
